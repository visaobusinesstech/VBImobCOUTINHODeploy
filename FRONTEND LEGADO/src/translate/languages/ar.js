const messages = {
  ar: {
    translations: {
      ...
      freeTrialRegister: {
        title: "إنشاء حساب",
        subtitle: "12 ساعة من الوصول الكامل إلى CRM. بدون بطاقة.",
        phone: "الهاتف (واتساب)",
        email: "البريد الإلكتروني",
        password: "كلمة المرور",
      ...
      login: {
        title: "تسجيل الدخول",
        tagline: "نظام إدارة علاقات العملاء للمستقبل",
        taglineLead: "",
        taglineWord1: "CRM",
        taglineMid: "",
        taglineWord2: "المستقبل",
        quote:
          "بينما لا يزال الكثيرون يدونون الملاحظات، يتوسع آخرون بالفعل. VBSolution CRM هو الفرق بين محاولة البيع وبناء آلة مبيعات.",
        author: "ليوناردو سينا",
        form: {
          email: "البريد الإلكتروني",
          password: "كلمة المرور",
          button: "الوصول",
        ...
        alerts: {
          googleNotRegistered:
            "لم نعثر على حساب مسجل باستخدام بريد Google المحدد. للوصول إلى المنصة، أكمل التسجيل أو سجّل الدخول بالبريد وكلمة المرور.",
        },
        toasts: {
          invalidEmail: "يرجى إدخال بريد إلكتروني صالح.",
          forgotPasswordInfo:
            "إذا كان بريدك الإلكتروني مسجلاً في نظامنا، فسيتم توجيهك إلى صفحة إعادة تعيين كلمة المرور.",
          popupBlocked: "اسمح بالنوافذ المنبثقة في هذا الموقع لتسجيل الدخول عبر Google.",
          googleFailed: "تعذر تسجيل الدخول عبر Google.",
          googleEmailNotRegistered:
            "لم نعثر على حساب مسجل باستخدام بريد Google المحدد.",
          googleLoginInvalid: "انتهت جلسة Google. حاول مرة أخرى.",
          outOfHours: "خارج ساعات العمل المسموح بها.",
        },
      },
      companies: {
        title: "تسجيل الشركة",
      ...
      transferTicketModal: {
        title: "نقل المحادثة",
        fieldLabel: "اختر المستخدم للنقل",
        selectPlaceholder: "انقر لفتح القائمة",
        searchPlaceholder: "تصفية بالاسم أو البريد…",
        selectAllVisible: "تحديد الكل (القائمة)",
        clearSelection: "إلغاء التحديد",
        loadAllUsers: "تحميل الجميع",
        multipleSelected: "{{count}} محددين",
        onlyOneRecipient:
          "للنقل، اختر مستخدماً واحداً كحد أقصى (أو لا أحد لتركه قيد الانتظار).",
      ...
      backendErrors: {
        ...
        ERR_GOOGLE_EMAIL_NOT_REGISTERED:
          "لم نعثر على حساب مسجل باستخدام بريد Google المحدد.",
        ERR_GOOGLE_LOGIN_INVALID: "انتهت جلسة Google. حاول مرة أخرى.",
