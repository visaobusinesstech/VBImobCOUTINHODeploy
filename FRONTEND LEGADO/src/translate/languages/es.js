const messages = {
  es: {
    translations: {
      register: {
        steps: {
          discovery: "Encuentro y necesidades",
        ...
        labels: {
          niche: "Rubro de actuación",
          foundUs: "Cómo nos conociste",
          needs: "Necesidad",
          ...
          phone: "Teléfono",
          publicName: "Nombre público de la empresa",
        ...
        options: {
          ...
          foundUs: {
            ...
            marketplace: "Marketplace/Socio",
            other: "Otro"
          },
          needs: {
            whatsappSupport: "Atención con WhatsApp",
            chatbotFlows: "Chatbot/Flujos",
            campaigns: "Campañas",
            reportsNps: "Informes/NPS",
            integrations: "Integraciones",
            leadManagement: "Gestión de leads",
            crmPipeline: "CRM y embudo de ventas",
            projectManagement: "Gestión de proyectos",
            kanbanTasks: "Kanban/Tareas",
            emailMarketing: "Email marketing",
            omnichannelCampaigns: "Campañas omnicanal",
            telephonyDialer: "Telefonía/Marcador",
            formsCapture: "Formularios y capturas",
            calendar: "Agenda/Calendario",
            advancedReportsBi: "Informes avanzados/BI",
            taskAutomation: "Automatización de tareas",
            erpEcommerceIntegrations: "Integraciones ERP/E-commerce",
        ...
        plans: {
          ...
          priceSuffix: "/mes",
          descriptions: {
            starter: "Recursos esenciales para empezar con un equipo reducido.",
            essential: "Funciones avanzadas y límites ampliados para escalar.",
            pro: "Para gran escala con automatizaciones e integraciones ilimitadas."
          },
          features: {
            starter: [
              "Crear y gestionar negocios y productos.",
              "Gestionar hasta 10k leads con control de etiquetas.",
              "Registro de hasta 3 miembros de la empresa.",
              "Automatizaciones para interactuar con leads.",
              "Atención múltiple con hasta 2 conexiones (WhatsApp).",
              "2 integraciones con Webhooks.",
              "Tableros de negocios de las pipelines."
            ],
            essential: [
              "Pipelines ilimitadas.",
              "Gestionar hasta 100k leads.",
              "Registro de 15 miembros de la empresa.",
              "Automatizaciones avanzadas.",
              "Hasta 10 conexiones (WhatsApp).",
              "15 integraciones con Webhooks.",
              "Tableros de negocios.",
              "Acceso a la API de integración."
            ],
            pro: [
              "Pipelines ilimitadas.",
              "Leads ilimitados con etiquetas.",
              "Negocios y productos avanzados.",
              "Miembros ilimitados en la empresa.",
              "Automatizaciones ilimitadas.",
              "Conexiones ilimitadas (WhatsApp).",
              "Integraciones con Webhooks ilimitadas.",
              "Tableros y API de integración."
            ]
          }
        }
      },
      ...
      freeTrialRegister: {
        title: "Crear cuenta",
        subtitle: "12 horas de acceso completo al CRM. Sin tarjeta.",
        ...
        phoneInvalid: "Teléfono inválido. Usa código de área y número de WhatsApp.",
        phoneRequired: "Ingresa el teléfono",
        ...
        passwordConfirmRequired: "Repite la contraseña",
        success: "Cuenta creada. Bienvenido a VBSolution CRM.",
        fail: "No se pudo crear la cuenta.",
        emailTaken: "Este correo ya está registrado",
        phoneTaken: "Teléfono ya registrado o inválido"
      },
      login: {
        title: "Inicio de Sesión",
        welcome: "Bienvenido de nuevo",
        loginInstruction: "Introduce tus datos para acceder a tu cuenta",
        tagline: "El CRM del Futuro",
        taglineLead: "El",
        taglineWord1: "CRM",
        taglineMid: "del",
        taglineWord2: "Futuro",
        quote:
          "Mientras muchos aún toman notas, otros ya están escalando. VBSolution CRM es la diferencia entre intentar vender y construir una máquina de ventas.",
        author: "Leonardo Sena",
        form: {
          email: "Correo Electrónico",
          password: "Contraseña",
          button: "Ingresar",
        ...
        links: {
          ...
          createAccount: "Crear cuenta ahora →",
        },
        alerts: {
          googleNotRegistered:
            "No encontramos una cuenta registrada con el correo de Google informado. Para acceder a la plataforma, complete su registro o inicie sesión con correo y contraseña.",
        },
        toasts: {
          invalidEmail: "Introduce un correo electrónico válido.",
          forgotPasswordInfo:
            "Si tu correo está registrado en nuestro sistema, serás redirigido a la página de restablecimiento de contraseña.",
          popupBlocked: "Permite ventanas emergentes en este sitio para entrar con Google.",
          googleFailed: "No se pudo iniciar sesión con Google.",
          googleEmailNotRegistered:
            "No encontramos una cuenta registrada con el correo de Google informado.",
          googleLoginInvalid: "Sesión de Google expirada. Inténtalo de nuevo.",
          outOfHours: "Fuera del horario laboral permitido.",
        },
      },
      companies: {
      ...
      dashboard: {
        ...
        searchResponsible: "Buscar agente…",
        selectAllResponsible: "Seleccionar todos",
        clearResponsibleSelection: "Limpiar",
        applyResponsibleFilter: "Aplicar",
        noResponsibleSearchResults: "No se encontraron agentes.",
        loadingUsersShort: "Cargando…",
        allUsersShort: "Todos",
        filter: "FILTRAR ",
        tabs: {
        ...
        whatsappIndicatorsSubtitle:
          "Métricas de conversaciones y colas en el período seleccionado arriba.",
        charts: {
          perDay: {
            title: "Tickets hoy: ",
          },
      ...
      whatsappModal: {
        ...
        wizard: {
          ...
          mode: {
            simple: "Simple",
            queues: "Filas",
            simpleHint: "El cliente no elige fila",
            queuesHint: "Requiere 2 o más filas para el menú",
          },
          messages: "Mensajes",
          greeting: "Saludo",
          farewell: "Despedida",
          ...
          directTo: "→",
          menuPlaceholder: "Elige una opción:",
          greetingPlaceholder: "¡Hola! ¿Cómo puedo ayudarte?",
          farewellPlaceholder: "¡Gracias por contactarnos!",
          agent: "Agente IA",
          agentLabel: "Agente",
          agentNone: "Ninguno",
          optional: "(opcional)",
          optionalNote: "Campos opcionales — puedes terminar sin completarlos",
          stepChooseQueues: "Filas",
          menuAndOrder: "Mensaje del Menú",
          queueEntry: "Entrada en fila",
          queueEntryPlaceholder: "Estás en la fila *{{queue}}*…",
          queueEntryDefault:
            "Estás en la fila *{{queue}}*. ¡Pronto serás atendido!",
          previewEmptyShort: "Selecciona filas",
          previewGreetingLabel: "Saludo — al iniciar",
          previewFarewellLabel: "Despedida — al cerrar",
          previewFarewellBadge: "Ticket cerrado",
          previewSimpleEmpty: "Activa saludo o despedida para ver la vista previa",
          previewDirectShort: "Directo a {{queue}}",
          stepChooseQueuesHint: "Selecciona qué filas puede elegir el cliente en la atención.",
          stepMenuMessage: "Mensaje del menú",
          stepMenuMessageHint: "Texto que aparece antes de las opciones numeradas en WhatsApp.",
          stepOrder: "Orden del menú",
          stepOrderHint: "Define la numeración que verá el cliente (1, 2, 3…).",
          stepPreview: "Vista previa",
          stepPreviewHint: "Mira cómo recibe el mensaje el cliente y cómo aparece el ticket en la lista.",
          stepDirect: "Direccionamiento",
          stepDirectHint: "Con una fila, el ticket va directo — sin menú para el cliente.",
          messagesOptional: "Mensajes extra",
          orderHint: "Usa las flechas para cambiar el orden de las opciones en el menú.",
          previewWhatsapp: "WhatsApp del cliente",
          previewTicket: "Ticket en la lista",
          previewToday: "Hoy",
          previewEmpty: "Completa las filas y el mensaje para ver la vista previa.",
          previewTypeMessage: "Mensaje",
          previewContact: "Maria Silva",
          previewWaiting: "Esperando atención…",
          previewStatus: "Esperando",
          previewDirect: "Ticket dirigido a {{queue}}",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      transferTicketModal: {
        ...
        transferTypeUser: "A usuario / fila",
        transferTypeConnection: "A otra conexión",
        fieldLabel: "Seleccione usuario para transferir",
        selectPlaceholder: "Haga clic para abrir la lista",
        searchPlaceholder: "Filtrar por nombre o correo…",
        selectAllVisible: "Marcar todos (lista)",
        clearSelection: "Desmarcar",
        loadAllUsers: "Cargar todos",
        multipleSelected: "{{count}} seleccionados",
        onlyOneRecipient:
          "Para transferir, elija como máximo un usuario (o ninguno para dejar pendiente).",
        fieldQueueLabel: "Transferir para fila",
        fieldQueuePlaceholder: "Seleccione una fila",
        fieldWhatsapp: "Seleccione un whatsapp",
        fieldConnectionLabel: "Seleccione la conexión",
        fieldConnectionPlaceholder: "Elija una conexión",
        connectionTypeHint: "Solo conexiones del tipo {{channel}}",
        noConnectionsAvailable: "No hay otra conexión disponible de este tipo",
      ...
      quickMessages: {
        ...
        pagination: {
          perPage: "hasta 500 por página",
          prev: "Página anterior",
          next: "Página siguiente",
          pageOf: "Página {{page}} de {{pages}}",
          total: "{{total}} respuesta(s)",
        },
      },
      contactLists: {
      ...
      backendErrors: {
        ...
        ERR_GOOGLE_EMAIL_NOT_REGISTERED:
          "No encontramos una cuenta registrada con el correo de Google informado.",
        ERR_GOOGLE_LOGIN_INVALID:
          "Sesión de Google expirada. Inténtalo de nuevo.",
      ...
      whitelabel: {
        ...
        buttonPrimaryTextColorsSection: "Texto de botones principales",
        buttonPrimaryTextColorLight: "Color del texto de botones principales (tema claro)",
        buttonPrimaryTextColorDark: "Color del texto de botones principales (tema oscuro)",
        buttonPrimaryTextColorsHint:
          "Opcional. Vacío = contraste automático sobre el color del botón (o primario del tema).",
      ...
      platformApi: {
        scopes: {
          ...
          contacts_read: "Leer contactos",
          contacts_write: "Crear/editar contactos",
          activities_read: "Leer actividades",
          activities_write: "Crear/editar actividades",
          leads_read: "Leer leads",
          leads_write: "Crear/editar leads",
          tickets_read: "Leer tickets",
          dashboard_read: "Panel",
          organization_read: "Datos de la organización",
          tools_execute: "Herramientas CRM (MCP/IA)"
        }
      },
    },
  },
