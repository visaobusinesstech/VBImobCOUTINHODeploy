          ...
          {tab === TAB_SCRIPT && (
            ...
            >
              <AgentScriptEditor
                ...
                placeholder="Roteiro: \\n = mesma bolha; linha em branco = bolha nova; — = quebra visual na mesma bolha. #mídia *variáveis. / é texto."
        ...
        <Box>
          ...
          {tab === TAB_SCRIPT && (
            <Paper className={classes.settingsCard} elevation={0}>
              ...
              <Typography variant="caption" color="textSecondary" display="block" style={{ marginBottom: 8 }}>
                Quando o agente deve seguir este roteiro e quando deve pausar para entender o pedido.
              </Typography>
              <TextField
                fullWidth
                multiline
                ...
                placeholder="Ex.: Se o cliente só pedir ajuda, pergunte o que precisa antes da etapa 1."
          ...
          <Paper className={classes.settingsCard} elevation={0}>
            ...
            <TextField
              ...
              helperText="Após gerar a resposta, a IA aguarda este tempo e exibe “digitando…” no WhatsApp antes de enviar."
              margin="dense"
              variant="outlined"
              size="small"
              className={classes.notionField}
