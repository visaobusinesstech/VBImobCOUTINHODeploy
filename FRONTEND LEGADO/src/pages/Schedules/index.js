...
import { listSchedulesCalendarEvents } from "../../services/googleWorkspaceService";
import IconButton from "@material-ui/core/IconButton";
import MenuIcon from "@material-ui/icons/Menu";
import { DrawerContext } from "../../context/DrawerContext";
import GoogleCalendarSyncPanel from "../../components/Schedules/GoogleCalendarSyncPanel";
import { coerceToDate, isDeadlineExpired } from "../../utils/deadlineDates";
...
const Schedules = () => {
  ...
  const handleOpenEventDrawer = (date) => {
    setDrawerInitialDate(coerceToDate(date));
  ...
  return (
      <div className="schedules-page" data-theme={muiTheme.palette.type}>
        ...
        <ActivitiesStyleLayout
          ...
          navActions={<CrmImportExportButton pageKey="calendar" />}
          disableFilterBar
          hideHeaderDivider
          hideNavDivider
          compactHeader
            ...
            <div className="schedules-aside-col">
              <div className="right-aside">
                ...
                <GoogleCalendarSyncPanel
                  connected={googleCalendarMeta.connected}
                  accountEmail={googleCalendarMeta.accountEmail}
                  showGoogleCalendar={showGoogleCalendar}
                  onToggleShow={setShowGoogleCalendar}
