...
import useBrainCrmSelection from "../../hooks/useBrainCrmSelection";
...
const QUICK_ACTIONS = [
  { icon: MetaQuickIcon, title: "Consultar Dados de Anúncios e Campanhas", prompt: "Consulte agora os dados reais de anúncios e campanhas Meta (get_meta_ads_analytics). Mostre gasto, impressões, CTR, CPC, leads Meta vs leads no CRM, receita atribuída, ROAS e top campanhas. Depois dê 3 recomendações práticas cruzando Ads + CRM (leads, atividades, follow-ups)." },
  { icon: MetaQuickIcon, title: "Otimizar funil Ads → CRM", prompt: "Use get_meta_ads_analytics e list_lead_sales para cruzar performance de campanhas Meta com oportunidades no CRM. Identifique campanhas caras com pouco lead CRM e sugira ações (pausar, criar follow-up, mover etapa)." },
  { icon: PencilLine, title: "Editar registro no CRM", prompt: "Quero editar algo que já existe no CRM (lead de venda, atividade, produto, projeto, contato, empresa ou agendamento). Pergunte o que alterar, localize o registro e use as tools update_* corretas." },
  { icon: Trash2, title: "Excluir registro no CRM", prompt: "Quero excluir um registro existente (lead, atividade, produto, projeto, contato, empresa ou agendamento). Localize, confirme comigo o id e só então use delete_*." },
  { icon: CalendarClock, title: "Agenda e atividades", prompt: "Liste minhas atividades e agendamentos. Ajude a criar, editar ou concluir itens da agenda/atividades conforme eu pedir." },
  ...
  { icon: MetaQuickIcon, title: "Enviar Template Meta", prompt: "Quero enviar um Template Meta (WhatsApp API Oficial) via campanha. Oriente: conexão oficial, templates sincronizados APPROVED, destinatários e agendamento ou envio imediato." },
...
export default function AiBrain({ embedded = false, onClose, contextSuggestions, pageContext }) {
  ...
  const { setSelectedCrms } = useBrainCrmSelection(user?.id);
  ...
  const toolNameMap = {
    create_activity: "Atividade", update_activity: "Atividade Editada", delete_activity: "Atividade Excluída",
    create_contact: "Contato", update_contact: "Contato Editado", delete_contact: "Contato Excluído",
    create_lead: "Lead", update_lead: "Empresa Editada", delete_lead: "Empresa Excluída",
    create_lead_sale: "Lead Venda", update_lead_sale: "Lead Venda Editado", delete_lead_sale: "Lead Venda Excluído",
    search_products: "Produtos",
    create_product: "Produto", update_product: "Produto Editado", delete_product: "Produto Excluído",
    ...
    create_project: "Projeto", update_project: "Projeto Editado", delete_project: "Projeto Excluído",
    list_schedules: "Agenda", create_schedule: "Agendamento", update_schedule: "Agenda Editada", delete_schedule: "Agenda Excluída",
    get_meta_ads_analytics: "Anúncios Meta", get_meta_ads_integration_status: "Meta Ads Status",
    crm_summary: "Resumo", generate_file: "Arquivo",
    create_connection: "Conexão", list_connections: "Conexões",
    create_quick_message: "Resposta Rápida",
