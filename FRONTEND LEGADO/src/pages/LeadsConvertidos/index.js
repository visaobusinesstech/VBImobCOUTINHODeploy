            ...
            leads.map((lead) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <CrmSourceBadge crmSource={lead.crmSource} showLabel />
                  </TableCell>
                  <TableCell>
                    {lead.sector ? (
...
const LeadsConvertidos = () => {
  ...
  const crmImportTick = useCrmImportRefresh("converted_leads");
  ...
  useEffect(() => {
    ...
    load();
  }, [searchParam, pageNumber, sector, responsible, contact, dateStart, dateEnd, crmImportTick]);
  ...
  const actionsRight = (
    <CrmImportExportButton pageKey="converted_leads" />
  );
