...
export default function MinimalLanguageSelector({
  ...
  return (
    <div
      className={`${classes.root} ${inline ? classes.rootInline : ""}`}
      ref={rootRef}
    >
      <button
        type="button"
        className={[
          classes.trigger,
          isLight ? classes.triggerLight : "",
          compact ? classes.triggerCompact : "",
        ].join(" ")}
      ...
      >
        <img
          src={current.icon}
          alt=""
          className={`${classes.flag} ${compact ? classes.flagCompact : ""}`}
        />
