...
export const CONNECTION_GUIDES = [
  ...
  },
  {
    ...
    label: "Facebook",
    accent: "#1877F2",
    tagline: "Messenger via Página — não é perfil pessoal",
    steps: [
      {
        title: "App Meta já publicado e aprovado",
        desc: "O CRM usa o app Meta da plataforma (Published / Live). Em produção, Messenger exige App Review com Advanced Access em pages_messaging, pages_manage_metadata e pages_show_list — com screencasts e política de privacidade. Painel: developers.facebook.com/apps → seu app → App Review → Permissions.",
      },
      {
        title: "Só Página (fan page), nunca perfil pessoal",
        desc: "Messenger no CRM só funciona com Página pública da empresa. Perfil pessoal do Facebook não conecta. Crie/administre em facebook.com/pages ou business.facebook.com.",
      },
      {
        title: "Você precisa ser admin da Página",
        desc: "A conta que clicar em Conectar com Facebook deve ter tarefa de administrador na Página. Sem isso o OAuth não lista a Página.",
      },
      {
        title: "Conectar no CRM",
        desc: "Integrações → Facebook → Administrar → Nova conexão → Conectar com Facebook. Autorize o app e selecione a Página. Mensagens do Messenger viram tickets em Atendimento.",
      },
      {
        title: "Webhooks e status Live",
        desc: "O app precisa estar Live (Published). Webhooks do objeto Page (messages) apontam para o backend HTTPS do CRM. Se DMs não chegarem, use Reparar webhooks Meta na conexão ou reconecte.",
      },
      {
        title: "Filas e atendimento",
        desc: "Associe filas em Filas & Chatbot. Responda pelo ticket dentro da janela de 24h do Messenger (tags Meta para fora da janela, se aprovadas).",
      },
    ],
    tip: "Criar Página:",
    tipLink: "https://www.facebook.com/pages/create",
    tipLinkLabel: "facebook.com/pages/create",
  },
  {
    id: "instagram",
    label: "Instagram",
    accent: "#E1306C",
    tagline: "Direct profissional — não conecta Instagram pessoal",
    steps: [
      {
        title: "App Meta com App Review (screencasts + segurança)",
        desc: "Direct de clientes exige app Live e Advanced Access. O fluxo do CRM usa Instagram Login com instagram_business_basic e instagram_business_manage_messages (aprovados no App Review com screencasts, Privacy Policy e Business Verification quando a Meta exigir). Painel: developers.facebook.com/apps → App Review e Instagram → API setup with Instagram login.",
      },
      {
        title: "Conta profissional — não use Instagram pessoal",
        desc: "Só conta Business ou Creator. Perfil pessoal não autoriza Direct via API/CRM. Converta em Configurações → Conta → Mudar para conta profissional no app Instagram.",
      },
      {
        title: "Vincule o Instagram a uma Página do Facebook",
        desc: "A conta profissional precisa estar ligada a uma Página (fan page) da empresa. Sem Página, a Meta não libera Direct para ferramentas. Ajuda: facebook.com/business/help/898752960195831 · Página: facebook.com/pages.",
      },
      {
        title: "Permitir acesso às mensagens (obrigatório)",
        desc: "Sem isso a Meta não entrega DMs para o CRM/API. No PC (mais fácil): facebook.com/settings → Permissions → Linked accounts → Instagram (@sua_conta) → ative “Allow access to Instagram messages in Inbox” / Permitir acesso às mensagens do Instagram na Caixa de entrada. No celular: Instagram → Configurações → Mensagens → Controles → Ferramentas conectadas → Permitir acesso às mensagens. Depois reconecte o Instagram no CRM.",
      },
      {
        title: "Redirect URI no Meta Developers",
        desc: "Em Instagram → API setup with Instagram login, cadastre exatamente: https://vbsolution.com.br/connections/instagram-oauth (e o domínio do seu front, se for outro). Sem isso o login falha com erro de redirect_uri.",
      },
      {
        title: "Conectar no CRM",
        desc: "Integrações → Instagram → Administrar → Nova → Conectar com Instagram (abre Instagram Login, não Facebook). Autorize a conta profissional. Depois envie um DM de teste de outra conta — o ticket deve aparecer em Atendimento.",
      },
      {
        title: "Se não criar ticket",
        desc: "Confira nesta ordem: (1) toggle de mensagens Instagram ON (Linked accounts ou Ferramentas conectadas), (2) app Live + App Review business, (3) Instagram↔Página, (4) redirect URI, (5) reconectar e Reparar webhooks Meta.",
      },
    ],
    tip: "Controle de mensagens (PC):",
    tipLink: "https://www.facebook.com/settings?tab=linked_accounts",
    tipLinkLabel: "facebook.com/settings → Linked accounts → Instagram",
  },
  {
    id: "email",
    label: "E-mail",
  ...
  },
  {
    ...
    accent: "#0081FB",
    tagline:
      "Um card: Gerenciador de Eventos (CAPI) + Anúncios & Pixels (Marketing API) + Análises Ads. Dá para conectar várias contas via OAuth.",
    steps: [
      {
        title: "Abra Meta Ads",
        desc: 'Integrações → Meta Ads → Criar conexão (Gerenciador de Eventos ou Anúncios & Pixels) ou o botão "Conectar outra conta via OAuth" ao lado de Criar conexão.',
      },
      {
        title: "Gerenciador de Eventos (CAPI)",
        desc: "Events Manager → Dataset CRM → Dataset ID + token da API Conversões. Rastreia CTWA e devolve Lead/Purchase.",
      },
      {
        title: "Várias contas Meta Ads",
        desc: "O botão Conectar outra conta via OAuth abre o login do Facebook, lista as ad accounts e cria no CRM os cards de Gerenciador de Eventos e Anúncios & Pixels daquela conta. Use o filtro Conta Meta Ads em Análises Ads para alternar.",
      },
      {
        title: "Anúncios & Pixels (Marketing API)",
        desc: "Ad Account + token ads_read (System User, Graph Explorer ou OAuth). Alimenta Mais → Análises Ads e o Brain.AI.",
      },
      {
        title: "Analisar",
        desc: "Mais → Análises Ads, ou no Brain use o atalho Consultar Dados de Anúncios e Campanhas.",
      },
    ],
    tip: "Events Manager:",
    tipLink: "https://business.facebook.com/events_manager2",
    tipLinkLabel: "Events Manager",
  },
  {
    id: "vbsolution-api",
    label: "API & MCP CRM",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "TikTok",
        desc: "Direct do TikTok: receber e enviar DMs, tickets no atendimento e uso em automações, filas e agentes de IA.",
      },
      {
        title: "Hotmart",
        desc: "Vendas de infoprodutos e checkouts Hotmart no CRM já vinculadas ao anúncio e à campanha que geraram a conversão.",
      },
      {
        title: "Cakto",
        desc: "Vendas do checkout Cakto no CRM já atribuídas aos anúncios — do clique na campanha até o pagamento aprovado.",
      },
    ],
    tip: "Facebook, Instagram, HubSpot, ClickUp, Pipedrive, Notion, Supabase, GitHub, Figma, Google Workspace e os provedores de IA já estão disponíveis para configurar.",
  },
];
