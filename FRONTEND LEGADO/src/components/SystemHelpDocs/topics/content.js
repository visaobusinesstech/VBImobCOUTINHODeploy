...
export const HELP_CONTENT = {
  ...
  metaAdsAnalytics: doc(
    "Análises Ads",
    "Painel estratégico da Marketing API: gasto, alcance, cliques, leads Meta × CRM e ROAS. Os dados vêm da conta conectada em Integrações → Meta Ads (Anúncios & Pixels ou OAuth de contas extras). O dashboard atualiza sozinho a cada ~45s com dados reais da Meta.",
    [
      {
        title: "Como usar",
        bullets: [
          "Faixa Dashboard: título Análises Ads, ícone de visibilidade para ocultar valores, idioma, Exportar e a conta Meta Ads + nome do app à direita",
          "Resumo: período, Conta Meta Ads, fonte, plataforma, produto e Mais filtros",
          "Atualizar: força nova leitura na Meta (o painel também atualiza sozinho a cada ~45s)",
          "Exportar: PDF/Excel/CSV dos dados atuais ou relatório estratégico GPT em PDF/Word",
        ],
      },
      {
        title: "Indicadores e gráficos",
        body: "Os cards mostram investimento, impressões, CTR/CPC, leads reportados pela Meta, leads atribuídos no CRM e ROAS. Os gráficos cobrem evolução diária, funil de conversão, eficiência por campanha e distribuição de verba.",
        tip: "Leads CRM / receita só aparecem quando oportunidades têm atribuição Meta Ads salva no CRM.",
      },
      {
        title: "Se algo vier zerado",
        bullets: [
          "Confirme token com ads_read e conta act_ correta",
          "Verifique se há gasto/impressões no período na Ads Manager",
          "Use Atualizar após trocar o token",
        ],
      },
    ]
  ),
  ...
  aiBrain: doc(
    ...
    [
      ...
      },
      {
        ...
        tip: "GPT, Claude, Gemini e Grok podem estar ativos juntos. Notion, GitHub e LinkedIn no hub Integrações ainda estão Em breve.",
      },
    ]
  ),
