...
const FACEBOOK_GUIDE_STEPS = [
  {
    title: "App Meta Live + App Review",
    desc: "A conexão permite acessar DMs e criar tickets com as DMs do Messenger. Exige app Meta Live com permissões de messaging aprovadas.",
    icon: Settings,
    color: "#1877F2",
    links: [
      { label: "Meta Developers — Apps", href: "https://developers.facebook.com/apps/" },
      {
  ...
  {
    title: "Página (fan page) — não perfil pessoal",
    desc: "Só Página pública da empresa conecta. Perfil pessoal do Facebook não funciona com Messenger no CRM. Você precisa ser administrador da Página.",
    icon: AccountCircle,
    color: "#1877F2",
    links: [
      { label: "Criar Página", href: "https://www.facebook.com/pages/create" },
      { label: "Meta Business Suite", href: "https://business.facebook.com/" },
    ],
  },
  {
    title: "Conectar com Facebook",
    desc: "Clique em Conectar com Facebook, autorize o app e selecione a Página. OAuth grava a conexão e inscreve webhooks de messages.",
    icon: LinkIcon,
    color: "#1877F2",
    links: [],
  },
  {
    title: "DMs e tickets no CRM",
    desc: "DMs do Messenger viram tickets em Atendimento. Com Agente IA na conexão, o bot responde como no WhatsApp. Responda pelo ticket ou deixe o agente atender.",
    icon: CheckCircleOutline,
    color: "#1877F2",
    links: [],
  },
...
const INSTAGRAM_GUIDE_STEPS = [
  {
    title: "App Meta aprovado (screencasts)",
    desc: "Direct de clientes exige app Live + App Review com Advanced Access em instagram_business_basic e instagram_business_manage_messages (vídeos/screencasts, política de privacidade e verificação de negócio quando a Meta pedir). Instagram pessoal NÃO conecta.",
    icon: Settings,
    color: "#E4405F",
    links: [
      { label: "Meta Developers — Apps", href: "https://developers.facebook.com/apps/" },
      {
        label: "Instagram Login — docs",
        href: "https://developers.facebook.com/docs/instagram-platform/instagram-api-with-instagram-login/",
      },
    ],
  },
  {
    title: "Conta Business/Creator + Página Facebook",
    desc: "A conexão permite acessar DMs, criar tickets com as DMs e automações envolvendo comentários. Use Instagram profissional (Business ou Creator) vinculado a uma Página do Facebook.",
    icon: AccountCircle,
    color: "#E4405F",
    links: [
      {
        label: "Vincular Instagram à Página",
        href: "https://www.facebook.com/business/help/898752960195831",
      },
      { label: "Criar Página Facebook", href: "https://www.facebook.com/pages/create" },
    ],
  },
  {
    title: "Controle de mensagens Instagram (obrigatório)",
    desc: "Ative o acesso às DMs para o CRM receber tickets. No PC: facebook.com/settings → Permissions → Linked accounts → Instagram → “Allow access to Instagram messages in Inbox” ON. No app: Mensagens → Controles → Ferramentas conectadas → Permitir acesso às mensagens. Depois reconecte no CRM.",
    icon: VpnKey,
    color: "#E4405F",
    links: [
      {
        label: "Linked accounts (Facebook)",
        href: "https://www.facebook.com/settings?tab=linked_accounts",
      },
    ],
  },
  {
    title: "Redirect URI no Meta Developers",
    desc: "Em Instagram → API setup with Instagram login, cadastre https://vbsolution.com.br/connections/instagram-oauth. Sem o redirect exato o OAuth falha.",
    icon: LinkIcon,
    color: "#E4405F",
    links: [
      { label: "Meta Developers — Apps", href: "https://developers.facebook.com/apps/" },
  ...
  {
    title: "Conectar com Instagram Login",
    desc: "Clique em Conectar Instagram Login. Autorize a conta profissional. A janela fecha sozinha quando a conexão for criada. Envie um DM de outra conta para validar o ticket.",
    icon: LinkIcon,
    color: "#E4405F",
    links: [],
  },
  {
    title: "Direct, tickets e comentários",
    desc: "DMs viram tickets no Atendimento. Com Agente IA na conexão, o bot responde como no WhatsApp. Automações de comentários ficam no Flow Builder.",
    icon: CheckCircleOutline,
    color: "#E4405F",
    links: [],
  },
