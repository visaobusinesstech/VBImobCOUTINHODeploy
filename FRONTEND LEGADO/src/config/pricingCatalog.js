...
export const BRAIN_SHARED_FEATURES = [
  ...
  "Conectores MCP · Notion, HubSpot, Figma e mais.",
...
export const BRAIN_PRICING_FEATURES = [
  ...
  },
  {
    ...
    values: {
      starter: "—",
      essencial: "Notion, HubSpot, Pipedrive",
      pro: "Supabase, Figma, Webhooks"
    }
  },
  {
