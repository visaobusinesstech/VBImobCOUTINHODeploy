...
export default function GeminiIntegrationModal({
  open,
  onClose,
  initialModel = "",
  onSaved
        ...
        <Box className={classes.titleRow}>
          <Box>
            ...
            <Typography className={classes.subtitle}>
              Provider isolado — Open IA e Claude permanecem inalterados. Configure API Key do Google AI Studio.
            </Typography>
          </Box>
