  ...
  return (
    <ConditionalTooltip tooltipEnabled={!!tooltip}>
      <ListItem
        ...
        onClick={(e) => {
          const scrollParent = e.currentTarget.closest(".MuiList-root");
          const top = scrollParent ? scrollParent.scrollTop : 0;
      ...
      {section === "main" && (
        <>
          ...
          <MenuGroup title={translateUi("Radar e portais")}>
            ...
            <ListItemLink to="/portais" primary={translateUi("Portais")} icon={<AppIcon icon={Building2} size={SIDEBAR_ICON_SIZE} />} tooltip={collapsed} collapsed={collapsed} />
