...
-- PostgreSQL requires at least one PERMISSIVE policy per command,
-- otherwise access is denied regardless of RESTRICTIVE policies.
-- =============================================
...
-- ===== followups (already fixed but ensuring) =====
