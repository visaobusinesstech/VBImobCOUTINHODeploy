...
//         await verifyMessage(send, ticket, contact, undefined, false, false, true);
...
//         await verifyMessage(sendMsg, ticket, contact, undefined, false, false, true);
...
export const sayChatbot = async (
  ...
  if (String(selectedOption).toLocaleLowerCase() === "sair") {
    ...
    if (!isNil(complationMessage)) {
      ...
      await verifyMessage(sendMsg, ticket, ticket.contact, undefined, false, false, true);
    }
