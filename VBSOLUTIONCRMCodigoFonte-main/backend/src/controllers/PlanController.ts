...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  const plan = await CreatePlanService({
    ...
    useWhatsapp: body.useWhatsapp !== false,
    useFacebook: body.useFacebook !== false,
    useInstagram: body.useInstagram !== false,
    useCampaigns: body.useCampaigns !== false,
    useSchedules: body.useSchedules !== false,
    useInternalChat: body.useInternalChat !== false,
    useExternalApi: body.useExternalApi !== false,
    useKanban: body.useKanban !== false,
    useOpenAi: body.useOpenAi !== false,
    useIntegrations: body.useIntegrations !== false,
    isPublic: body.isPublic !== false,
    useWhatsappOfficial: Boolean(body.useWhatsappOfficial),
    trial: Boolean(body.trial),
    trialDays: Number(body.trialDays) || 0,
    recurrence: body.recurrence ? String(body.recurrence) : "monthly",
    wavoip: Boolean(body.wavoip)
  });
